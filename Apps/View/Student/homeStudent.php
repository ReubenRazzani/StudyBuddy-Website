...
<html lang="en">
    ...
    <body>
        ...
        <div class="hero-banner">
            <img src="../../../Public/assets/compare-fibre-Y8TiLvKnLeg-unsplash.jpg" alt="">
            <div class="banner-text">
                <h1>STUDYBUDDY</h1>
                <h3>Menemani Keberhasilanmu</h3>
                <h5>Temukan Mentor yang akan membantumu meraih impianmu</h5>
                <button>
                    Cari Sekarang
                </button>
            </div>
        ...
        <div class="features">
            <h2>Fasilitas STUDYBUDDY</h2>
            <div class="feature-list">
                <div class="f-list" href="#">
                    <img src="../../../Public/assets/undraw_people_search_re_5rre.svg" alt="">
                    <h5>Pencarian Mentor</h5>
                    <p>Fasilitas pencarian mentor bagi murid sebagai pendamping belajar untuk membantu kemampuan akademis</p>
                </div>
                <div class="f-list" href="#">
                    <img src="../../../Public/assets/undraw_online_learning_re_qw08.svg" alt="">
                    <h5>Jadwal Konsultasi</h5>
                    <p>Murid dapat melihat jadwal konsultasi yang telah disetujui oleh mentor dengan terstruktur</p>
                </div>
                <div class="f-list" href="#">
                    <img src="../../../Public/assets/undraw_online_test_re_kyfx.svg" alt="">
                    <h5>Mata Pelajaran</h5>
                    <p>Penekanan intensif terhadap mata pelajaran utama yang terdaftar dan menjadi fokus utama kami untuk murid STUDYBUDDY</p>
                </div>
            </div>
        </div>
        ...
        <div class="user-wallet">
            ...
            <div class="wallet-banner">
                <div class="e-wallet-icon">
                    <div class="top-wallet">
                        <svg xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2023 Fonticons, Inc.--><path fill="#7fff00" d="M64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V192c0-35.3-28.7-64-64-64H80c-8.8 0-16-7.2-16-16s7.2-16 16-16H448c17.7 0 32-14.3 32-32s-14.3-32-32-32H64zM416 272a32 32 0 1 1 0 64 32 32 0 1 1 0-64z"/></svg>
                        <h5>STUDYBUDDY e-wallet</h5>
                    </div>
                ...
                <div class="persuasive-desc">
                    <h5>Top Up sekarang dan cari mentor terbaik dari kami yang akan mendampingimu</h5>
                </div>
            </div>
            <div class="wallet-action">
                <div class="topup-action">
                    <div class="topup-icon">
                        <button onclick="showTopupForm()">
                            <svg xmlns="http://www.w3.org/2000/svg" height="16" width="14" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2023 Fonticons, Inc.--><path fill="#000000" d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z"/></svg>
                        </button>
                    </div>
            ...
            <div id="topupModal" class="modal">
                <div class="modal-content">
                    <span class="close" onclick="closeTopupForm()">&times;</span>
                    <h3>Jumlah Topup</h3>
                    <form id="topupForm" action="../../Routes.php?topup" method="post">
                        <input type="number" name="topupAmount" placeholder="Top-Up Amount">
                        <button type="submit" value="Top-Up">Top-Up</button>
                    </form>
                </div>
            </div>
        </div>
            ...
            <div class="accordion" id="accordionExample">
                <div class="accordion-item">
                    <h3 class="accordion-header">
                        ...
                        Bagaimana Cara Mencari Mentor di STUDYBUDDY?
                        </button>
                    </h3>
                    ...
                    <h3 class="accordion-header">
                        ...
                        Apakah Mentor STUDYBUDDY dapat Diandalkan?
                        </button>
                    </h3>
                    ...
                    <h3 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                            Bagaimana Cara Mengetahui Perjanjian yang Telah Dibuat dengan Mentor?
                        </button>
                    </h3>
