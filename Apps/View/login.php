        ...
        <div class="main-banner">
                ...
                <div class="lb-content">
                    <div class="top">
                        <div class="back-button">
                            ...
                            <a href="registerStudent.php"><h5>Kembali</h5></a>
                        </div>
                        <h1>STUDYBUDDY</h1>
                    </div>
                    <hr>
            ...
            <div class="right-banner">
                <div class="rb-content">
                    <div class="banner">
                        <h3>LOGIN</h3>
                        <form id="loginStudentForm" action="../Routes.php?login" method="post" onsubmit="return validateFormData()">
                            <div id="email">
                                <div class="mb-3">
                                    <label for="emailInput" class="form-label">Alamat Email</label>
                                    <input type="email" class="form-control" id="emailInput" name="emailInput" placeholder="name@example.com" autocomplete='off'>
                                </div>
                            </div>
                            <div id="password">
                                <label for="passwordInput" class="form-label">Kata Sandi</label>
                                <input type="password" id="passwordInput" class="form-control" name="passwordInput" aria-describedby="passwordHelpBlock" autocomplete='off'>
