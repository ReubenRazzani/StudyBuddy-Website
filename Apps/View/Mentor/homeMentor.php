...
try {
    $stmt = $db_conn->prepare("CALL GetMentorSchedule(?)");
...
<head>
    ...
    <link rel="stylesheet" href="../../../Public/css/homeMentor.css">
    ...
    <div class="inbox-content">
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo date('H:i', strtotime($row['SCHEDULE_TIME'])); ?></td>
                    <td><?php echo $row['SCHEDULE_STATUS']; ?></td>
                    <td>
                        <button id="approve" onclick="showTopupForm()">Setuju</button>
                    </td>
                    <td>
                        <form action="../../Routes.php?decline" method="post">
                            <input type="hidden" name="declineScheduleID" id="scheduleID" value="<?= $row['SCHEDULE_ID']; ?>">
                            <button id="decline" name="decline" type="submit">Tolak</button>
                        </form>
                    </td>
                </tr>
                <?php
        ...
        <div id="topupModal" class="modal">
            <div class="modal-content">
                ...
                <h5>Persetujuan</h5>
                <form id="topupForm" action="../../Routes.php?approve" method="post">
                    <input type="hidden" name="scheduleID" id="scheduleID" value="<?= $row['SCHEDULE_ID']; ?>">
                    <input type="text" name="subject" placeholder="Keterangan pertemuan">
                    <input type="text" name="zoom" placeholder="Link pertemuan">
                    <button type="submit" value="approve">Kirim</button>
                </form>
            </div>
        </div>
    </div>
